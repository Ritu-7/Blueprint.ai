    ...
    <div className="flex min-h-screen bg-[#0a0d14]">
      ...
      >
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="mt-4 max-w-sm text-sm leading-7 text-white/50">
              Turn a single prompt into a polished app workspace — live preview, generated files, database schema, and API docs.
            </p>
          </div>
        ...
        <p className="text-xs text-white/25 leading-5">
          &ldquo;It feels like V0 and Cursor had a product-minded workflow.&rdquo;
        </p>
      </motion.aside>
